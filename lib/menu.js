...
(function() {
  ...
  this.updateMenu = function() {
    var b, backingTex, diffBorder, difficultyButtons, lvlText, nextBorder, nextLvl, prevBorder, prevLvl, size, _i, _len;
    ...
    for (_i = 0, _len = difficultyButtons.length; _i < _len; _i++) {
      b = difficultyButtons[_i];
      try {
