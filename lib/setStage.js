...
(function() {
  ...
  this.initMenu = function() {
    var bck, easyBorder, easyButton, hardBorder, hardButton, helpBorder, helpButton, lvlText, medBorder, medButton, menuicon, nextLvl, prevLvl, resetBorder, resetButton, titleText;
  ...
  this.updateMenu = function() {
    ...
    this.g.drawRect(0, 0, 45, 25);
    this.g.endFill();
    backingTex = this.g.generateTexture();
