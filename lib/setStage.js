...
(function() {
  ...
  this.preloadImages = function() {
    var assets, loader;
    assets = ["assets/img/galaxy-28.jpg", "assets/img/helpBackground.png", "assets/img/icon.png", "/assets/img/hex-back.png", "assets/img/core.png", "assets/img/spark.png", "assets/img/crystal.png", "assets/img/connector_off.png", "assets/img/connector_on.png"];
  ...
  this.resize = function() {
    var bck, cContainer, col, fixY, goalContainer, helpBack, helpButton, helpHeight, helpWidth, icon, lvlPush, lvlText, margin, menuHeight, menumargin, n, newScale2, newScale3, newX, nextLvl, prevLvl, resetButton, scale, title, _ref, _ref1, _ref2;
    margin = 0;
  ...
  this.createSpriteForHex = function(hex) {
    var backpanel, col, core, coreContainer, coreRad, cpanel, cr, i, point, radTo60Degree, sidePanels, spr, trim, _j, _k, _len1, _ref1, _ref2;
    if (typeof hex.panel === "undefined" || hex.panel === null) {
      ...
      if (hex instanceof Prism) {
        ...
        for (i = _j = 0, _ref1 = Hex.SIDES - 1; _j <= _ref1; i = _j += 1) {
          ...
          point = new PIXI.Point(coreRad * Math.cos((i - 2) * 2 * Math.PI / Hex.SIDES + radTo60Degree / 2 + trim), coreRad * Math.sin((i - 2) * 2 * Math.PI / Hex.SIDES + radTo60Degree / 2 + trim));
