...
(function() {
  ...
  this.updateMenu = function() {
    var b, backingTex, diffBorder, difficultyButtons, lvlText, nextBack, nextBorder, nextLvl, prevBack, prevBorder, prevLvl, size, _j, _len1;
    lvlText = this.menu.children[4];
    ...
    if (this.level > 1) {
      ...
      prevBack = new PIXI.Sprite(this.backBox(size, 25));
    ...
    if (this.level < 50) {
      ...
      nextBack = new PIXI.Sprite(this.backBox(size, 25));
