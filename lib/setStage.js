...
(function() {
  ...
  this.createHelpMenu = function() {
    ...
    helpContainer.addChild(PIXI.Sprite.fromImage(this.siteprefix + "assets/img/helpBackground.png"));
  ...
  this.resize = function() {
    var bck, cContainer, col, easyButton, fixY, fixYRowTwo, goalContainer, hardButton, helpBack, helpButton, helpGoalHighlight, helpGoalText, helpHeight, helpWidth, icon, lvlPush, lvlText, margin, medButton, menuHeight, menumargin, n, newScale2, newScale3, newX, nextLvl, prevLvl, resetButton, scale, title, _ref, _ref1, _ref2;
    margin = 0;
  ...
  this.onBoardLoad = function() {
    ...
    this.goalContainer.count = Math.max(i, 3);
    spaceCoef = 5 / 6;
    pushCoef = 1 / 4;
