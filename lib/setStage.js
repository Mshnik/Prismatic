...
(function() {
  ...
  this.createHelpMenu = function() {
    var backr, bottomContent, close, contentStyle, crystalIcon, crystalsContent, crystalsHeader, goalOverlay, goalText, headerStyle, helpContainer, overlay, overlaySprite, prismIcon, prismsContent, prismsHeader, sparkIcon, sparksContent, sparksHeader, tagText, title, topContent;
    ...
    backr = PIXI.Sprite.fromImage(this.siteprefix + "assets/img/helpBackground.png");
    backr.height = 365;
    ...
    sparkIcon = PIXI.Sprite.fromImage(this.siteprefix + "assets/img/spark.png");
    ...
    prismIcon = PIXI.Sprite.fromImage(this.siteprefix + "assets/img/hex-back.png");
    ...
    crystalIcon = PIXI.Sprite.fromImage(this.siteprefix + "assets/img/crystal.png");
  ...
  this.preloadImages = function() {
    var assets, loader;
    assets = [this.siteprefix + "assets/img/galaxy-28.jpg", this.siteprefix + "assets/img/helpBackground.png", this.siteprefix + "assets/img/Icon_v2.png", this.siteprefix + "assets/img/hex-back.png", this.siteprefix + "assets/img/core.png", this.siteprefix + "assets/img/spark.png", this.siteprefix + "assets/img/crystal.png", this.siteprefix + "assets/img/connector_off.png", this.siteprefix + "assets/img/connector_on.png"];
  ...
  this.initFinish = function() {
    ...
    window.count = 0;
    animate = function() {
      var a, col, connector, contain, core, curLit, goalContainer, h, hLit, inc, isWin, n, nConnector, nS, pan, panel, radTo60Degree, rotSpeed, spr, tolerance, value, _j, _k, _l, _len1, _len10, _len11, _len2, _len3, _len4, _len5, _len6, _len7, _len8, _len9, _m, _n, _o, _p, _q, _r, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9, _s, _t;
      window.count += 1;
      ...
      if ((this.BOARD != null)) {
        ...
        if (__modulo(window.count, 250) === 0) {
          contain = this.colorContainersArr[0];
          this.colorContainersArr = this.colorContainersArr.splice(1, this.colorContainersArr.length - 1);
          _ref3 = this.colorContainersArr;
          for (_l = 0, _len3 = _ref3.length; _l < _len3; _l++) {
            a = _ref3[_l];
            console.log(a.color);
          }
          this.stage.removeChild(contain);
          this.colorContainersArr.push(contain);
          _ref4 = this.colorContainersArr;
        ...
        for (_n = 0, _len5 = _ref5.length; _n < _len5; _n++) {
          ...
          if (h instanceof Prism) {
            ...
            for (col in _ref6) {
              core = _ref6[col];
              if ((_ref7 = col.toLowerCase(), __indexOf.call(hLit, _ref7) < 0) && core.alpha > 0) {
                core.alpha = 0;
              } else if ((_ref8 = col.toLowerCase(), __indexOf.call(hLit, _ref8) >= 0) && core.alpha === 0) {
                core.alpha = 0.75;
              }
            }
          }
          ...
          for (col in _ref9) {
            ...
            for (_o = 0, _len6 = _ref10.length; _o < _len6; _o++) {
              ...
              if ((n != null) && __indexOf.call(hLit, c) >= 0 && n.colorOfSide(n.indexLinked(h)) === c && !connector.linked) {
                ...
                _ref11 = n.colorPanels;
                for (_p = 0, _len7 = _ref11.length; _p < _len7; _p++) {
                  nConnector = _ref11[_p];
                ...
                this.toUnlit(connector);
                if (n != null) {
                  _ref12 = n.colorPanels;
                  for (_q = 0, _len8 = _ref12.length; _q < _len8; _q++) {
                    nConnector = _ref12[_q];
                    if (nConnector.side === n.indexLinked(h) && nConnector.linked) {
  ...
  this.updateMenu = function() {
    var b, backingTex, diffBorder, difficultyButtons, lvlText, nextBorder, nextLvl, prevBorder, prevLvl, size, _j, _len1;
    lvlText = this.menu.children[4];
    ...
    for (_j = 0, _len1 = difficultyButtons.length; _j < _len1; _j++) {
      b = difficultyButtons[_j];
      try {
  ...
  this.clearBoard = function() {
    ...
    sprToRemove = [];
    _ref1 = this.menu.children[this.goalContainerIndex].children;
    for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
      pan = _ref1[_j];
      _ref2 = pan.children;
      for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
  ...
  this.onBoardLoad = function() {
    var color, colors, fix, goalArr, goalBoard, goalCount, goalStyle, h, i, key, pushCoef, r, removeCount, s, spaceCoef, spark, spr, text, use, val, _j, _k, _l, _len1, _len2, _len3, _len4, _len5, _m, _n, _o, _p, _ref1, _ref2, _ref3, _ref4, _ref5;
    if (!this.initted) {
      window.initMenu();
    ...
    for (_j = 0, _len1 = colors.length; _j < _len1; _j++) {
      c = colors[_j];
      for (i = _k = 1, _ref1 = window.BOARD[c.toUpperCase()]; _k <= _ref1; i = _k += 1) {
    ...
    this.BOARD.moves = 0;
    for (i = _l = 1; _l <= removeCount; i = _l += 1) {
    ...
    spaceCoef = 5 / 6;
    pushCoef = 1 / 4;
    _ref4 = goalBoard.allHexesOfClass("Crystal");
    ...
    for (_o = 0, _len4 = colors.length; _o < _len4; _o++) {
      c = colors[_o];
      if (window.BOARD[c.toUpperCase()] === 0) {
        this.colorContainers[c.toUpperCase()].alpha = 0;
        _ref5 = window.BOARD.allHexesOfClass("Spark");
