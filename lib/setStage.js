...
(function() {
  ...
  this.difficulty = this.Game.EASY;
  ...
  this.onBoardLoad = function() {
    var color, colors, goalArr, goalBoard, goalCount, goalStyle, i, pushCoef, r, removeCount, spaceCoef, spr, text, _j, _k, _l, _len1, _len2, _len3, _m, _n, _ref1, _ref2;
    if (!this.initted) {
      window.initMenu();
      this.initted = true;
    }
