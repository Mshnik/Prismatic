...
(function() {
  ...
  this.onBoardLoad = function() {
    var color, colors, goalArr, goalBoard, goalCount, goalStyle, i, pushCoef, r, removeCount, s, spaceCoef, spark, spr, text, _j, _k, _l, _len1, _len2, _len3, _len4, _len5, _m, _n, _o, _p, _ref1, _ref2, _ref3;
    if (!this.initted) {
      window.initMenu();
      this.initted = true;
    }
    ...
    spaceCoef = 5 / 6;
    pushCoef = 1 / 4;
    _ref2 = goalBoard.allHexesOfClass("Crystal");
    ...
    for (_o = 0, _len4 = colors.length; _o < _len4; _o++) {
      ...
      if (window.BOARD[c.toUpperCase()] === 0) {
        ...
        _ref3 = window.BOARD.allHexesOfClass("Spark");
