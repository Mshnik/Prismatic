...
this.clearBoard = function() {
  var i, j, k, l, len, len1, len2, len3, len4, m, n, o, p, pan, q, ref, ref1, ref2, ref3, ref4, ref5, spr, sprToRemove;
  sprToRemove = [];
  ...
  ref2 = this.stage.children[1].children;
  for (m = 0, len2 = ref2.length; m < len2; m++) {
    spr = ref2[m];
    sprToRemove.push(spr);
  }
  for (i = n = 1, ref3 = this.stage.children.length - 1; n <= ref3; i = n += 1) {
    ref4 = this.stage.children[i].children;
    for (o = 0, len3 = ref4.length; o < len3; o++) {
      pan = ref4[o];
      for (j = p = 1, ref5 = pan.children.length; p <= ref5; j = p += 1) {
        spr = pan.children[j];
        sprToRemove.push(spr);
      }
    }
  }
  for (q = 0, len4 = sprToRemove.length; q < len4; q++) {
    spr = sprToRemove[q];
    if (spr != null) {
...
this.onBoardLoad = function() {
  var c, color, colors, fix, goalArr, goalBoard, goalCount, h, i, k, key, l, len, len1, len2, len3, m, n, o, p, pushCoef, r, ref, ref1, ref2, ref3, ref4, removeCount, s, spaceCoef, spark, use, val;
  if (!this.initted) {
    window.initMenu();
  ...
  for (k = 0, len = colors.length; k < len; k++) {
    c = colors[k];
    for (i = l = 1, ref = window.BOARD[c.toUpperCase()]; l <= ref; i = l += 1) {
  ...
  this.BOARD.moves = 0;
  for (i = m = 1, ref3 = removeCount; m <= ref3; i = m += 1) {
  ...
  spaceCoef = 5 / 6;
  pushCoef = 1 / 4;
  for (o = 0, len2 = colors.length; o < len2; o++) {
    c = colors[o];
    if (window.BOARD[c.toUpperCase()] === 0) {
      this.colorContainers[c.toUpperCase()].alpha = 0;
      ref4 = window.BOARD.allHexesOfClass("Spark");
