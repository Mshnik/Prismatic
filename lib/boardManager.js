...
this.onBoardLoad = function() {
  ...
  spaceCoef = 5 / 6;
  pushCoef = 1 / 4;
  ref4 = goalBoard.allHexesOfClass("Crystal");
...
this.createSpriteForHex = function(hex) {
  var backpanel, c, combo, con, cpanel, diff, fixAndRotateConnector, i, indices, j, k, l, len, len1, m, n, o, pairCombos, radTo60Degree, ref, ref1, ref2, ref3, ref4, sideOne, sidePanels, sideTwo, spr, theSide;
