...
(function() {
  ...
  this.animate = function() {
    var col, connector, core, curLit, goalContainer, h, hLit, inc, isWin, n, nConnector, nPanel, nS, nSide, newSides, pan, panel, radTo60Degree, rotSpeed, side, spr, tolerance, value, _j, _k, _l, _len1, _len10, _len11, _len12, _len13, _len14, _len15, _len16, _len2, _len3, _len4, _len5, _len6, _len7, _len8, _len9, _m, _n, _o, _p, _q, _r, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref18, _ref19, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9, _s, _t, _u, _v, _w, _x, _y;
    window.count += 1;
      ...
      for (_l = 0, _len3 = _ref3.length; _l < _len3; _l++) {
        ...
        for (_m = 0, _len4 = _ref7.length; _m < _len4; _m++) {
          ...
          for (_n = 0, _len5 = _ref8.length; _n < _len5; _n++) {
            connector = _ref8[_n];
            _ref9 = connector.sides;
            for (_o = 0, _len6 = _ref9.length; _o < _len6; _o++) {
              side = _ref9[_o];
              n = nS[side];
              if ((n != null) && __indexOf.call(hLit, col) >= 0 && n.colorOfSide(n.indexLinked(h)) === col && !connector.linked) {
                this.toLit(connector);
                _ref10 = n.colorPanels;
                for (_p = 0, _len7 = _ref10.length; _p < _len7; _p++) {
                  nPanel = _ref10[_p];
                  _ref11 = nPanel.children;
                  for (_q = 0, _len8 = _ref11.length; _q < _len8; _q++) {
                    nConnector = _ref11[_q];
                    _ref12 = nConnector.sides;
              ...
              } else if (connector.linked && __indexOf.call(hLit, col) < 0) {
                this.toUnlit(connector);
                if (n != null) {
                  _ref13 = n.colorPanels;
                  for (_s = 0, _len10 = _ref13.length; _s < _len10; _s++) {
                    nPanel = _ref13[_s];
                    _ref14 = nPanel.children;
                    for (_t = 0, _len11 = _ref14.length; _t < _len11; _t++) {
                      nConnector = _ref14[_t];
                      _ref15 = nConnector.sides;
        ...
        if (h instanceof Prism && h.currentRotation !== h.targetRotation) {
          ...
          if (Math.abs(h.targetRotation - h.currentRotation) < tolerance) {
            ...
            h.backPanel.rotation += inc * radTo60Degree;
            h.currentRotation += inc;
            _ref17 = h.colorPanels;
            for (_w = 0, _len14 = _ref17.length; _w < _len14; _w++) {
              value = _ref17[_w];
              value.rotation += inc * radTo60Degree;
              _ref18 = value.children;
              for (_x = 0, _len15 = _ref18.length; _x < _len15; _x++) {
                spr = _ref18[_x];
                newSides = [];
                _ref19 = spr.sides;
                for (_y = 0, _len16 = _ref19.length; _y < _len16; _y++) {
                  side = _ref19[_y];
                  newSides.push(__modulo(side + (h.currentRotation - h.prevRotation), Hex.SIDES));
                }
                spr.sides = newSides;
              }
            }
  ...
  this.resize = function() {
    var bck, cContainer, col, dumSpr, easyButton, effectiveCount, fixY, fixYRowTwo, goalContainer, hardButton, helpBack, helpButton, helpGoalHighlight, helpGoalText, helpHeight, helpWidth, icon, lvlPush, lvlText, margin, medButton, menuHeight, menumargin, n, newScale2, newScale3, newX, nextLvl, prevLvl, resetButton, scale, subPane, subPaneArr, title, _j, _len1, _ref1, _ref2, _ref3;
    margin = 0;
    ...
    if (this.BOARD != null) {
      ...
      for (col in _ref3) {
        ...
        for (_j = 0, _len1 = subPaneArr.length; _j < _len1; _j++) {
          subPane = subPaneArr[_j];
